  ...
  inquirer
    ...
    .then((answers: any) => {
      ...
      if (guessNumber === randomNumber) {
        ...
        console.log(
          chalk.white.bgRed(
            `Too low, kindly guess again.You have ${remainingChances} chances left: `
          )
        );
        } else{
            console.log(
                      chalk.white.bgBlueBright(
                        `Too high, kindly guess again. You have ${remainingChances} chances left: `
                      )
                    );
        ...
        if (remainingChances === 0) {
          console.log(
            chalk.green.bgRed(
              `We are really sorry you have missed you all chances and the correct number is ${randomNumber}`
            )
          );
